    ...
    <section className="px-0 py-4 md:py-6">
      <div className="relative overflow-hidden rounded-[34px] border border-[#f3cdcd] bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.96)_0%,rgba(255,244,242,0.98)_44%,rgba(255,231,227,0.94)_100%)] px-4 py-5 shadow-[0_32px_90px_rgba(144,20,14,0.12)] sm:px-6 md:px-8 md:py-8">
        ...
        <div className="relative z-10 mb-8 text-center">
          ...
          <h3 className="mt-4 text-[34px] md:text-[44px] font-fla leading-none text-[#160101]">
            {title}
          </h3>
          {subtitle ? (
            <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-[#5f4848] sm:text-base md:text-lg">
              {subtitle}
            </p>
          ) : null}
        </div>
              ...
              >
                <div className="relative aspect-16/10 min-h-100 overflow-hidden rounded-3xl sm:min-h-117.5 w-full">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-5 text-white sm:p-7">
                    <h4 className="max-w-xl text-3xl font-fla leading-none sm:text-[42px]">
                      {currentSlide?.title}
                    </h4>
                  </div>
                </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-1 text-xl font-fla leading-none text-[#160101]">
                          {slide.title}
                        </p>
                      </div>
                    </div>
