  ...
  return (
    <div className="px-4 py-8">
      <div className="max-w-5xl mx-auto mb-6">
        <h1 className="font-contrail-one text-[#000000] text-[48px] md:text-[56px] tracking-tight">LA FUNDACIÓN</h1>
      ...
      <div className="max-w-5xl mx-auto mb-8 rounded-[80px] overflow-hidden relative shadow-lg">
        <div className="w-full h-[260px] bg-center bg-cover bg-no-repeat" style={{ backgroundImage: `url('${imgSerParteDeFlaNoEsSimplementeVoluntariarEsConectarConPersonasIncreiblesCrearRecuerdosInolvidablesYApostarASerParteDelCambioQueDeseasVerEnLaComunidadEnFlaHemosCompartidoMomento1}')` }} />
        <div className="absolute inset-0 bg-[#f45e5e] opacity-45 rounded-[80px]" />
      </div>
