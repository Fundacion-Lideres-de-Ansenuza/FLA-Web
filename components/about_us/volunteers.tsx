...
export default function Volunteers(): JSX.Element {
  ...
  return (
    <section id="voluntariado" className="grid items-center gap-6 lg:grid-cols-[0.78fr_1.22fr] min-h-[400px] scroll-mt-[120px]">
      <div className="flex justify-center items-center">
        <div className="w-full max-w-[360px] rounded-[30px] bg-[linear-gradient(180deg,#fff4f4_0%,#ffffff_100%)] px-6 py-8 text-center shadow-[0_18px_40px_rgba(144,20,14,0.08)]">
          <h3 className="mt-3 font-fla text-[#160101] text-[72px] md:text-[80px] leading-none">+{CURRENT_VOLUNTEERS}</h3>
          <p className="mt-2 font-fla text-[#160101] text-[28px] md:text-[34px] leading-tight text-center">{t("aboutUs.volunteers.current")}</p>
        </div>
      </div>
