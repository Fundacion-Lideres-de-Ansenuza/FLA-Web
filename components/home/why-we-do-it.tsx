    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-left mb-10">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">POR QUÉ LO HACEMOS?</h2>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          <div className="relative rounded-3xl overflow-hidden shadow-xl">
            ...
            <div className="relative bg-red-600/85 text-white p-10 rounded-3xl">
              <h3 className="text-5xl md:text-6xl font-extrabold leading-none">Impacto social</h3>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-xl">
            ...
            <div className="relative bg-red-700/85 text-white p-10 rounded-3xl">
              <h3 className="text-5xl md:text-6xl font-extrabold leading-none">Educación</h3>
              <p className="mt-6 text-lg md:text-xl leading-relaxed max-w-xl">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-xl">
          ...
          <div className="relative bg-red-800/85 text-white p-10 rounded-3xl">
            <h3 className="text-5xl md:text-6xl font-extrabold leading-none">Oportunidades</h3>
