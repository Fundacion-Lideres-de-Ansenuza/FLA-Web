...
export default function Features() {
	const features = [
		...
		},
		{
			...
			description:
				"Seamlessly collaborate with your team members in real-time, anywhere in the world.",
		...
		},
		{
			...
			description:
				"Access your dashboard on any device with our fully responsive mobile-first design.",
		...
		},
		{
			...
			title: "Global Reach",
			description:
				"Scale globally with multi-region deployment and localization support for 50+ languages.",
			...
			<div className="container mx-auto px-4">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						...
						choice for businesses of all sizes looking to accelerate their growth.
					</p>
				</div>
